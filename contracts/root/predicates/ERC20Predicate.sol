...
contract ERC20Predicate is IErcPredicate {
   ...
   */
    function processReferenceTx(
        ...
        // When child chain is started, since child TOK is a genenis contract at 0x1010,
        // the root token corresponding to TOK is not known, hence child token address is emitted in LogFeeTransfer events.
