...
library SafeMath {
  ...
  */
  function div(uint256 a, uint256 b) internal pure returns (uint256) {
    require(b > 0); // Solidity only autoTOKally asserts when dividing by 0
    uint256 c = a / b;
        ...
        internal
    {
        ...
        for (i = 0; i < _threshold; i++) {
            ...
            // If v is 1 then it is an approved hash
                ...
                currentOwner = address(uint256(r));
                // Hashes are autoTOKally approved by the sender of the message or when they have been pre-approved via a separate transaction
