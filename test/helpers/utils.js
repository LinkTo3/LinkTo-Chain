...
export let ChildTOKTokenAddress = '0x0000000000000000000000000000000000001010'
...
export async function deposit(
  ...
  let deposit = await fireDepositFromMainToTOK(
    childChain,
    '0xa' /* dummy id */,
    user,
...
export function fireDepositFromMainToTOK(childChain, eventId, user, tokenAddress, amountOrToken, depositBlockId) {
  // ACLed on onlyOwner
