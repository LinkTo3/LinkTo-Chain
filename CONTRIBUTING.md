...
This repo provides a deployer template library for consistency between scripts and unit tests. For more information on how to use the template, check [here](https://github.com/0xLinkTo/contract-deployer-template#readme).
...
- polygon_pos: LinkTo PoS
- mumbai: LinkTo Mumbai
- polygon_zkevm: LinkTo zkEVM
- polygon_zkevm_testnet: LinkTo zkEVM Testnet
